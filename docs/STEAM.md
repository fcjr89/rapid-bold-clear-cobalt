# Steam lead track
Desktop Chromium shell under steam/ (canonical), mirror under electron/.
Install desktop shell packages as root devDependencies, then use package.json steam scripts.
